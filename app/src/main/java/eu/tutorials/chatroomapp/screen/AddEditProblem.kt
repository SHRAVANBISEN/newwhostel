...
fun AddEditDetailView(
    ...
    val statusBarColor = colorResource(id = eu.tutorials.chatroomapp.R.color.nmb) //..
            ...
            topBar = {
                CenterAlignedTopAppBar(modifier = Modifier.fillMaxWidth(),
                    ...
                    colors = TopAppBarDefaults.centerAlignedTopAppBarColors(
                        containerColor = colorResource(id = eu.tutorials.chatroomapp.R.color.nmb)
                    ),
                    title = {
                        Text(
                            text = "Add Problems",
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = {
                        androidx.compose.material3.Text(
                            text = "Text", color = colorResource(id = R.color.nmb),
                            fontSize = 22.sp,
                    ...
                    colors = TextFieldDefaults.outlinedTextFieldColors(
                        ...
                        focusedBorderColor = colorResource(id = eu.tutorials.chatroomapp.R.color.nmb),
                        unfocusedBorderColor = colorResource(id = eu.tutorials.chatroomapp.R.color.nmb),
                        cursorColor = colorResource(id = eu.tutorials.chatroomapp.R.color.nmb),
                    ),
                )
                ...
                OutlinedTextField(
                    ...
                    label = {  androidx.compose.material3.Text(
                        text = "Description", color = colorResource(id = R.color.nmb),
                        fontSize = 22.sp,
                        fontWeight = FontWeight.ExtraBold,
                        modifier = Modifier.padding(bottom = 22.dp, start = 5.dp,)
                    ) },
                    ...
                    colors = TextFieldDefaults.outlinedTextFieldColors(
                        ...
                        // using predefined Color
                        textColor = colorResource(id = eu.tutorials.chatroomapp.R.color.white),
                        // using our own colors in Res.Values.Color
                        backgroundColor = Color.Transparent,
                        focusedBorderColor = colorResource(id = eu.tutorials.chatroomapp.R.color.nmb),
                        unfocusedBorderColor = colorResource(id = eu.tutorials.chatroomapp.R.color.nmb),
                ...
                Button(
                    ...
                    modifier = Modifier.padding(top = 16.dp) , colors = ButtonDefaults.buttonColors(colorResource(id = R.color.nmb))
                ) {
