    ...
    Box(
        ...
        Column(
            ...
            Column(
                ...
                Button(
                    ...
                    colors = ButtonDefaults.buttonColors(containerColor = colorResource(id = R.color.nmb)), // Button color
        ...
        if (isLoading) {
            Box(
                ...
                val composition by rememberLottieComposition(LottieCompositionSpec.RawRes(R.raw.anime3))
                LottieAnimation(
                    composition,
